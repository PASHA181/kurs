...
$('a[rel=creat_new_category]').live("click", function(){
    ...
    // прячем строку с указанием родительской категории
    if(!parent_name){
      $('.creat_category_table .parentCategory').css('display', 'none');
    }else{
      $('.creat_category_table .parentCategory').css('display', 'block');
    }
